package net.cutefox.robotmod.entity.custom;
...
public class EvilRobotEntity extends HostileEntity implements IAnimatable {
      private AnimationFactory factory = new AnimationFactory(this);

    public EvilRobotEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    protected void initGoals() {
        ...
        this.targetSelector.add(2, new ActiveTargetGoal<>(this, TraderLlamaEntity.class, true));
    }
    ...
    private PlayState attackPredicate(AnimationEvent event) {
        if(this.handSwinging && event.getController().getAnimationState().equals(AnimationState.Stopped)) {
            ...
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.robot.attack", false));
